...
def get_recession_start():
    ...
    for i in range(2, len(df)):
        ...
        if (df.iloc[i - 2][1] > df.iloc[i - 1][1]) and (
...
def run_ttest():
    ...
    # 주거 dataframe 파악
    df_cityhome = convert_housing_data_to_quarters().loc[
    ...
    df_cityhome["price_ratio"] = (
        df_cityhome[recession_start] - df_cityhome[recession_bottom]
    ) / df_cityhome[recession_start]
    # print(df_cityhome)
