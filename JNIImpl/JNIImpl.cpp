...
JNIEXPORT void JNICALL Java_JNIManager_Print(JNIEnv *env, jobject obj)
{
	printf("This C Java_JNIManager_Print()\n");
	return;
}
JNIEXPORT jint JNICALL Java_JNIManager_Add(JNIEnv *env, jobject obj, jint a, jint b)
{
...
JNIEXPORT jstring JNICALL Java_JNIManager_PrintString(JNIEnv *env, jobject obj, jstring msg)
{
