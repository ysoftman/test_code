...
echo "[cat redirect_open_read_write_test.txt]"
cat redirect_open_read_write_test.txt
echo "[rm -f redirect_open_read_write_test.txt]"
rm -f redirect_open_read_write_test.txt
...
echo "$var1"
zzz
echo "[cat redirect_test.sh]"
cat redirect_test.sh
echo "[rm -f redirect_test.sh]"
rm -f redirect_test.sh
...
echo "$var1"
zzz
echo "[cat /etc/redirect_sudo_test.sh]"
cat /etc/redirect_sudo_test.sh
echo "[sudo rm /etc/redirect_sudo_test.sh]"
sudo rm /etc/redirect_sudo_test.sh
