////////////////////////////////////////////////////////////////////////////////////
// ysoftman
// zlib 테스트 : stdin 으로 입력된 문자를 압축한다.
////////////////////////////////////////////////////////////////////////////////////
#include <stdio.h>
#include <string.h>
#include <assert.h>
...
int main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		...
		fprintf(stderr, "Compress   : %s src.txt dst.txt\n", argv[0]);
		fprintf(stderr, "Decompress : %s -d src.txt dst.txt\n", argv[0]);
		return 1;
	}
	// 압축하기
	else if (argc == 3)
	{
		...
		ret = def(fpSrc, fpDst, Z_DEFAULT_COMPRESSION);
		if (ret != Z_OK)
		{
			zerr(ret);
		}
