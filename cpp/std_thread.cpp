...
void func_thread1()
{
    for (int i = 0; i < 5; i++)
    {
        ...
        cout << "thread1) std::this_thread::get_id()" << std::this_thread::get_id() << "  " << i << endl;
    }
}
...
void func_thread2()
{
    for (int i = 0; i < 5; i++)
    {
        ...
        cout << "thread2) std::this_thread::get_id()" << std::this_thread::get_id() << "  " << i << endl;
    }
}
...
int main()
{
    ...
    cout << "main thread) std::this_thread::get_id() " << std::this_thread::get_id() << "  all threads done" << endl;
    return 0;
}
