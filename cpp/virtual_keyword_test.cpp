...
class Parent {
   public:
    virtual void public_func() { cout << "Parent public_func()\n"; }

   protected:
    void parent_protected_func() { cout << "Parent protected_func()\n"; }

   private:
    void parent_private_func() { cout << "Parent private_func()\n"; }
};
...
class Child : public Parent {
   ...
   protected:
    void protected_func() { cout << "Child protected_func()\n"; }

   private:
    void private_func() { cout << "Child private_func()\n"; }
};
