...
LRESULT CALLBACK ImageInputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
...
void CreateImageFrame1InputWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageFrame1InputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Frame2 Image File Open
void CreateImageFrame2InputWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageFrame2InputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
...
LRESULT CALLBACK ImageLPFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//HPF
void CreateImageHPFWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageHPFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//MF
void CreateImageMFWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageMFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//HFEF
void CreateImageHFEFWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageHFEFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//BN
void CreateImageBNWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageBNProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//WN
void CreateImageWNWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageWNProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//BWN
void CreateImageBWNWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageBWNProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Erosion
void CreateImageErosionWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageErosionProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Dilation
void CreateImageDilationWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageDilationProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Opening
void CreateImageOpeningWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageOpeningProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Closing
void CreateImageClosingWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageClosingProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Binary Image
void CreateImageBinaryWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageBinaryProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Thinning
void CreateImageThinningWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageThinningProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//DCT
void CreateImageDCTWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageDCTProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//IDCT
void CreateImageIDCTWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageIDCTProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//HARDAMARD
void CreateImageHARDAMARDWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageHARDAMARDProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//IHARDAMARD
void CreateImageIHARDAMARDWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageIHARDAMARDProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//WAVELET
void CreateImageWAVELETWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageWAVELETProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//IWAVELET
void CreateImageIWAVELETWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageIWAVELETProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//DCT_JPEG
void CreateImageDCT_JPEGWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageDCT_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//Quantization_JPEG
void CreateImageQuantization_JPEGWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageQuantization_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//IQuantization_JPEG
void CreateImageIQuantization_JPEGWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageIQuantization_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);

//IDCT_JPEG
void CreateImageIDCT_JPEGWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageIDCT_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);




//Make Frame 1'
void CreateImageMakeF1_Window(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageMakeF1_Proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);


//Make Frame 2 - Frame 1'
void CreateImageMakeF2F1_Window(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageMakeF2F1_Proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);


//Result Frame
void CreateImageMakeRFWindow(HWND hParent,int x,int y,int width,int height);
LRESULT CALLBACK ImageMakeRFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam);
...
void DrawImage(HDC hdc, int width, int height, unsigned char (*pImage)[COL])
{
	...
	SetDIBitsToDevice(hdc, 0, 0, width, height, 0, 0, 0, height, (const void*)pBits, &bmi, DIB_RGB_COLORS);
	delete[] pBits;
}
					 ...
					 int       nCmdShow)
{
	...
	//Create Main Window
	hMainWnd=CreateWindow(lpszClass,
		lpszClass,
		WS_OVERLAPPEDWINDOW,
		CW_USEDEFAULT,
		CW_USEDEFAULT,
	...
	if(!RegisterClass(&WndClass))
	{
		MessageBox(NULL,"Register ImageQuantization_JPEGClass Error","Error",MB_OK);
	}
	...
	if(!RegisterClass(&WndClass))
	{
		MessageBox(NULL,"Register ImageIQuantization_JPEGClass Error","Error",MB_OK);
	}
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		EnableMenuItem(GetMenu(hWnd), IDM_QUANTIZATION_JPEG, MF_GRAYED | MF_BYCOMMAND);
		EnableMenuItem(GetMenu(hWnd), IDM_IQUANTIZATION_JPEG, MF_GRAYED | MF_BYCOMMAND);
	...
	case WM_COMMAND:
		...
		case IDM_OUTPUT:
			...
			//Image Frame1 Input
		case IDM_F1INPUT:
			hFile = CreateFile("ImageProcessing_tabletennis74.raw",
				GENERIC_READ,
				0,
				NULL,
				OPEN_EXISTING,
			...
			//Image Frame2 Input
		case IDM_F2INPUT:
			hFile = CreateFile("ImageProcessing_tabletennis75.raw",
				GENERIC_READ,
				0,
				NULL,
				OPEN_EXISTING,
		...
		default:
			return DefWindowProc(hWnd, message, wParam, lParam);	//Else Default Message Return
		}
		break;
...
void CreateImageInputWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc1=CreateWindow(szImageInputClass,"Input Image(Original Image)",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			//WS_POPUPWINDOW | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,	//POPUP WINDOW
...
LRESULT CALLBACK ImageInputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		MessageBox(hWnd, "First Of All, You Must Select Image(Click Image)", "INPUT IMAGE OPEN", MB_OK);
		break;
	...
	case WM_LBUTTONDOWN:
		...
		//EnableMenuItem(GetMenu(hMainWnd), IDM_IHARDAMARD, MF_ENABLED | MF_BYCOMMAND);
		...
		//EnableMenuItem(GetMenu(hMainWnd), IDM_QUANTIZATION_JPEG, MF_ENABLED | MF_BYCOMMAND);
		//When QUATIZATION_JPEG Window Executed...
		//EnableMenuItem(GetMenu(hMainWnd), IDM_IQUANTIZATION_JPEG, MF_ENABLED | MF_BYCOMMAND);
...
void CreateImageOutputWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc2=CreateWindow(szImageOutputClass,"Output Image(Image Copy)",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,		
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc2)
		{
...
void CreateImageFrame1InputWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hcf1=CreateWindow(szImageFrame1InputClass,"Input Frame1 Image",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
...
LRESULT CALLBACK ImageFrame1InputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		MessageBox(hWnd, "You Must Select Frame1(Click Image)", "INPUT Frame1 IMAGE OPEN", MB_OK);
		break;
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select Input Frame1 Image, Frame2 Input Menu Enabled...", "SELECT IMAGE", MB_OK);
		break;
...
void CreateImageFrame2InputWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hcf2=CreateWindow(szImageFrame2InputClass,"Input Frame2 Image",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
...
LRESULT CALLBACK ImageFrame2InputProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		MessageBox(hWnd, "You Must Select Frame2(Click Image)", "INPUT Frame2 IMAGE OPEN", MB_OK);
		break;
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select Input Frame2 Image, Make Frame 1' Menu Enabled.", "SELECT IMAGE", MB_OK);
...
void CreateImageLPFWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc3=CreateWindow(szImageLPFClass,"LPF",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc3)
		{
...
LRESULT CALLBACK ImageLPFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	//1/9,  1/9,  1/9
	//1/9,  1/9,  1/9
	double LPFMask[3][3] = {0.11, 0.11, 0.11,
		0.11, 0.11, 0.11,
		0.11, 0.11, 0.11};
	...
	case WM_CREATE:
		...
		for(row = 0; row < ROW; row++)
		{
			...
			{				  	
				...
				//rgbtemp = buf[row][col];
				//3 x 3
				LPFImage[row+1][col+1] = (unsigned char)((TImage[row+0][col+0] * LPFMask[0][0])+
...
void CreateImageHPFWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc4=CreateWindow(szImageHPFClass,"HPF",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc4)
		{
...
LRESULT CALLBACK ImageHPFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	//-1/9,  8/9, -1/9,
	//-1/9, -1/9, -1/9, 
	double HPFMask[3][3] = {{-0.11, -0.11, -0.11},
	{-0.11,  0.88, -0.11},
	{-0.11, -0.11, -0.11}};
	...
	case WM_CREATE:
		for(row = 0; row < ROW; row++)
		{
			...
			{				  	
				...
				//rgbtemp = buf[row][col];
				//3 x 3
				HPFImage[row+1][col+1] = (unsigned char)((TImage[row+0][col+0] * HPFMask[0][0])+
...
void CreateImageMFWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc5=CreateWindow(szImageMFClass,"MF",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc5)
		{
...
void CreateImageHFEFWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc6=CreateWindow(szImageHFEFClass,"HFEF",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc6)
		{
...
LRESULT CALLBACK ImageHFEFProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	double HFEFMask[3][3] = {-0.11, -0.11, -0.11,
		-0.11,   0.0, -0.11,
		-0.11, -0.11, -0.11};
	...
	case WM_CREATE:
		...
		for(row = 0; row < ROW-1; row++)
		{
			...
			{				  	
				...
				//3 x 3
				HFEFImage[row+1][col+1] = (unsigned char)((TImage[row+0][col+0] * HFEFMask[0][0])+
				...
				//				(TImage[row+4][col+4] * HFEFMask[4][4]));
			}
		}
		break;
...
void CreateImageBNWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc7=CreateWindow(szImageBNClass,"BN",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc7)
		{
...
void CreateImageWNWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc8=CreateWindow(szImageWNClass,"WN",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc8)
		{
...
void CreateImageBWNWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc9=CreateWindow(szImageBWNClass,"BWN",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc9)
		{
...
void CreateImageErosionWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc10=CreateWindow(szImageErosionClass,"Erosion",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc10)
		{
...
LRESULT CALLBACK ImageErosionProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		for (row = 0; row < ROW; row++)
		{
			for (col = 0; col < COL; col++)
			{
				ErosionImage[row][col] = MIN(TImage[row][col+EMask[0]],
					TImage[row][col+EMask[1]],
...
void CreateImageDilationWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc11=CreateWindow(szImageDilationClass,"Dilation",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
...
LRESULT CALLBACK ImageDilationProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		for (row = 0; row < ROW; row++)
		{
			for (col = 0; col < COL; col++)
			{
				DilationImage[row][col] = MAX(TImage[row][col-DMask[0]],
					TImage[row][col-DMask[1]],
...
void CreateImageOpeningWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc12=CreateWindow(szImageOpeningClass,"Opening",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc12)
		{
...
LRESULT CALLBACK ImageOpeningProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		for (row = 0; row < ROW; row++)
		{
			...
			{
				//Eroded
				ErodedImage[row][col] = MIN(TImage[row][col+EMask[0]],
					TImage[row][col+EMask[1]],
					TImage[row][col+EMask[2]]);
			}
		}
...
void CreateImageClosingWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc13=CreateWindow(szImageClosingClass,"Closing",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc13)
		{
...
LRESULT CALLBACK ImageClosingProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		for (row = 0; row < ROW; row++)
		{
			...
			{
				//Dilated
				DilatedImage[row][col] = MAX(TImage[row][col-DMask[0]],
					TImage[row][col-DMask[1]],
					TImage[row][col-DMask[2]]);
			}
		}
...
void CreateImageBinaryWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc14=CreateWindow(szImageBinaryClass,"Binary",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc14)
		{
...
void CreateImageThinningWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc15=CreateWindow(szImageThinningClass,"Thinning",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc15)
		{
			...
			for (u = 0; u < 8; u++)
			{
				for (v = 0; v < 8; v++)
				{
					...
					for (x = 0; x < 8; x++)
					{
						...
						{
							accum += (double)(
								(double)forward[x+jumpx][y+jumpy]
...
void CreateImageDCTWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc16=CreateWindow(szImageDCTClass,"DCT",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc16)
		{
...
LRESULT CALLBACK ImageDCTProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select DCT Image, IDCT Menu Enabled....", "SELECT IMAGE", MB_OK);
...
void CreateImageIDCTWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc17=CreateWindow(szImageIDCTClass,"IDCT",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc17)
		{
...
void CreateImageHARDAMARDWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc18=CreateWindow(szImageHARDAMARDClass,"HARDAMARD",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc18)
		{
...
LRESULT CALLBACK ImageHARDAMARDProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select HARDAMARD Image, IHARDAMARD Menu Enabled...", "SELECT IMAGE", MB_OK);
...
void CreateImageIHARDAMARDWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc19=CreateWindow(szImageIHARDAMARDClass,"IHARDAMARD",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc19)
		{
...
LRESULT CALLBACK ImageIHARDAMARDProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Can't Select IHARDAMARD Image...", "SELECT IMAGE", MB_OK);
...
void CreateImageWAVELETWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc20=CreateWindow(szImageWAVELETClass,"WAVELET",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc20)
		{
...
LRESULT CALLBACK ImageWAVELETProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select Wavelet Image, Inverse Wavelet Menu Enabled...", "SELECT IMAGE", MB_OK);
		EnableMenuItem(GetMenu(hMainWnd), IDM_IWAVELET, MF_ENABLED | MF_BYCOMMAND);
...
void CreateImageIWAVELETWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc21=CreateWindow(szImageIWAVELETClass,"IWAVELET",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc21)
		{
...
void IWAVELET(double WaveletedImage[ROW][COL])
{
	...
	for (x = 0; x < ROW; x++)
	{
		...
		for (y = 0; y < 128; y++)
		{
			plus = ((float)TempImage[x+0][y+0]
			+ (float)TempImage[x+0][y+128]);

			minus = ((float)TempImage[x+0][y+0]
			- (float)TempImage[x+0][y+128]);
...
LRESULT CALLBACK ImageIWAVELETProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Can't Select Inverse WAVELET Image...", "SELECT IMAGE", MB_OK);
...
void CreateImageDCT_JPEGWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc22=CreateWindow(szImageDCT_JPEGClass,"DCT_JPEG",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc22)
		{
...
LRESULT CALLBACK ImageDCT_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select DCT_JPEG Image, Quantization Menu Enabled....", "SELECT IMAGE", MB_OK);
...
void Quantization_JPEG(double DCTedImage[ROW][COL])
{
	...
	//////////////////////////////////////////////////////
	unsigned char QUANT_TABLE[8][8] = {16,11,10,16,24,40,51,61,
...
void CreateImageQuantization_JPEGWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc23=CreateWindow(szImageQuantization_JPEGClass,"Quantization_JPEG",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc23)
		{
...
LRESULT CALLBACK ImageQuantization_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		for (row = 0; row < ROW; row++)
		{
			for (col = 0; col < COL; col++)
			{
				Quantization_JPEGImageTemp[row][col] = (int)(Quantization_JPEGImage[row][col]);
			}
		}
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select Quantization_JPEG Image, IQuantization_JPEG Menu Enabled....", "SELECT IMAGE", MB_OK);
...
void CreateImageIQuantization_JPEGWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc24=CreateWindow(szImageIQuantization_JPEGClass,"IQuantization_JPEG",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc24)
		{
...
LRESULT CALLBACK ImageIQuantization_JPEGProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_PAINT:
		...
		for (row = 0; row < ROW; row++)
		{
			for (col = 0; col < COL; col++)
			{
				IQuantization_JPEGImageTemp[row][col] = (int)(IQuantization_JPEGImage[row][col]);
			}
		}
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Select IQuantization_JPEG Image, IDCT_JPEG Menu Enabled....", "SELECT IMAGE", MB_OK);
...
void CreateImageIDCT_JPEGWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc25=CreateWindow(szImageIDCT_JPEGClass,"IDCT_JPEG",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc25)
		{
				...
				for (j = 0; j < 16; j++)
				{
					...
					for (k = 0; k < 16; k++)
					{
						for (l = 0; l < 16; l++)
						{
							...
							sum_temp += abs(CF[frow+k][fcol+l] - RF[frow+i+k][fcol+j+l]);
...
void CreateImageMakeF1_Window(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc26=CreateWindow(szImageMakeF1_Class,"Make Frame 1'",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc26)
		{
...
LRESULT CALLBACK ImageMakeF1_Proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Cliked Make Frame 1' , Make Frame 2 - Frame 1' Menu Enabled", "SELEECT IMAGE", MB_OK);
...
void CreateImageMakeF2F1_Window(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc27=CreateWindow(szImageMakeF2F1_Class,"Make Frame 2 - Frame 1'",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc27)
		{
			MessageBox(hc27,"Non Input Image","Make Frame 2 - Frame 1' Error",MB_OK);
		}
	}
}
...
LRESULT CALLBACK ImageMakeF2F1_Proc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		for (frow = 0; frow < FROW; frow++)
		{
			for (fcol = 0; fcol < FCOL; fcol++)
			{
				F2F1_Image[frow][fcol] = InputFrame2Image[frow][fcol] - F1_Image[frow][fcol];
			}
		}
		break;
	...
	case WM_LBUTTONDOWN:
		...
		MessageBox(hWnd, "You Cliked Make Frame 2 - Frame 1' , Make Result Frame Menu Enabled", "SELEECT IMAGE", MB_OK);
		break;
	case WM_MOVE:
		InvalidateRect(hWnd, NULL, FALSE);
		break;
...
void CreateImageMakeRFWindow(HWND hParent,int x,int y,int width,int height)
{
	...
	{
		hc28=CreateWindow(szImageMakeRFClass,"Make Result Frame",
			WS_OVERLAPPED | WS_CHILD | WS_BORDER | WS_SYSMENU | WS_CAPTION | WS_VISIBLE,
			x,y,width,height,hParent,(HMENU)NULL,g_hInst,NULL);
		if(!hc28)
		{
