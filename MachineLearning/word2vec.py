...
[용어]
CBOW(Continuos Bag-of-Words) : 연속되는(문장에서 빈곳) 단어를 예측하는 모델, 작은 데이터셋에 적합
...
# 2. 데이터를 기반으로 사전 만들기, 드문 단언들은 UNK(unkown?) 토큰으로 변경
...
try:
    ...
    plot_with_labels(low_dim_embs, labels,
                     os.path.join(os.path.abspath(__file__), 'tsne.png'))
