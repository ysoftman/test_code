...
debug += "arr.find((item) => {...})=" + arr.find((item) => {
	return item == 'a'
})
debug += "\n"
...
debug += "\n"
// 배열 처음에 원소 추가
debug += "arr.unshift('first_element')=" + arr.unshift('first_element') + " arr=" + arr
debug += "\n"
// 배열 처음에 원소 삭제
...
debug += "delete arr[3]=" + delete arr[3] + "  arr=" + arr + "  arr[3]=" + arr[3] + " arr.length=" + arr.length
debug += "\n"
console.log(debug)
...
debug += "String(arr2d)==='1,2,3,4,5,6' --> " + (String(arr2d) === "1,2,3,4,5,6") + "\n"
console.log(debug)
